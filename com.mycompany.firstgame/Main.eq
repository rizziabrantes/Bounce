...
public class Main: SEScene
{
	...
	public void initialize(SEResourceCache rsc) {
		...
		rsc.prepare_image("pig","pig",get_scene_width()*0.1,get_scene_height()*0.1);
		fg=add_sprite_for_image(SEImage.for_resource("pig"));
		fg.move(100,100);

		rsc.prepare_font("myfont","arial bold color=white",60);
		display = "BOUNCE BABY BOUNCE = %d".printf().add(Primitive.for_integer(bounce)).to_string();
